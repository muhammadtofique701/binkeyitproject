    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await Axios({
                ...SummaryApi.forgot_password_otp_verfication,
                data : {
                    otp : data.join(""),
    ...
    return (
        <section className='w-full container mx-auto px-2'>
            <div className='bg-white my-4 w-full max-w-lg mx-auto rounded p-7'>
                <p className='font-samibold text-lg'>Enter Otp</p>
                                ...
                                data.map((element,index)=>{
                                    return(
                                            <input
                                                ...
                                                maxLength={1}
                                                className='bg-blue-50 p-2 w-full max-w-16 border rounded outline-none focus:border-amber-200 text-center font-samibold'
                                            />
                                    ) 

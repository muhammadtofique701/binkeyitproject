  ...
  return (
    <div className=''>
        <div className='bg-white shadow-lg px-2 py-2 flex justify-between gap-4 items-center '>
            ...
            <button onClick={()=>setOpenAddress(true)} className='border border-green-500 text-green-500 px-3 hover:bg-green-500 hover:text-black py-1 rounded-full cursor-pointer'>
                Add Address
            </button>
        </div>
        <div className='bg-blue-50 p-2 grid gap-4'>
              {
                addressList.map((address,index)=>{
                  return(
                      <div className={`border rounded p-3 flex gap-3 bg-white ${!address.status && 'hidden'} hover:bg-green-100`}>

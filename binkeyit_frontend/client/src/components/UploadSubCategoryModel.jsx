...
const UploadSubCategoryModel = ({ close, fetchData }) => {
    ...
    const allCategory = useSelector(state => {
        console.log("All Categories", state.product.allCategory);
    ...
    return (
        <section className='fixed top-0 right-0 bottom-0 left-0 bg-neutral-800/25 z-50 flex items-center justify-center p-4'>
                ...
                <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    ...
                    <button
                        ...
                        className={`px-4 py-2 border
                            ${subCategoryData?.name && subCategoryData?.image && subCategoryData?.category[0] ? "bg-amber-300 hover:bg-amber-400" : "bg-amber-300"}

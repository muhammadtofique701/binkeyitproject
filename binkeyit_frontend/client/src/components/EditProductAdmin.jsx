...
const EditProductAdmin = ({close,data : propsData}) => {
    ...
    return (
        <section className='fixed top-0 right-0 left-0 bottom-0 bg-black/25 z-50 p-8'>
            <div className='bg-white w-full p-4 max-w-3xl mx-auto rounded overflow-y-auto h-full mx-h-[90vh]'>
                <section className='p-4'>
                    <div className='p-4 bg-white shadow-md flex items-center justify-between'>
                        ...
                        <button onClick={close} className='cursor-pointer'><IoClose size={20}/></button>
                    </div>
                    ...
                    <div className='grid p-4'>
                        <form className='grid gap-4' onSubmit={handlesubmit}>
                            ...
                            <button className='bg-yellow-300 hover:bg-yellow-400 py-2 rounded font-semibold cursor-pointer'>Update Product</button>
                        </form>
                    </div>
                    {
                        ViewImageURL && (
